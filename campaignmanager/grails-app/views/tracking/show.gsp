...
<html>
    ...
    <body>
        ...
        <div id="show-tracking" class="content scaffold-show" role="main">
            ...
            <f:display bean="tracking" />
            <g:form resource="${this.tracking}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tracking}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
